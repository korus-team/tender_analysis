...
меню в консоли. Данные берутся из tenders.db (её наполняет main.py при парсинге).
...
Статус живёт отдельно от парсинга: повторный запуск main.py не сбросит его.
"""
